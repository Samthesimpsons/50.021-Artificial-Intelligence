...
class Node:
    ...
    # Error was < not supported for class node, python3 must define comparison methods for classes
    # solved by https://portingguide.readthedocs.io/en/latest/comparisons.html
...
def iterative_deepening_search(problem):
    "[Fig. 3.18]"
    # xrange python2 -> range python3, maxsize too
